...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/a5cg2i63/settings/api) and create a token with read rights.
